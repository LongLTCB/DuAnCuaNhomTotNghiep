...
public class CorridorFirstDungeonGenerator : PhuongTrinhTaoHamNgucNgauNhienDonGian
{
    [SerializeField]
    ...
    [SerializeField]
    private SimpleRandomWalkSO roomGenerationParameters;
    ...
    private void CorridorFirstGeneration()
    {
        ...
        FloorPositions = new HashSet<Vector2Int>(floorPositions);
    ...
    private List<List<Vector2Int>> CreateCorridors(HashSet<Vector2Int> floorPositions, HashSet<Vector2Int> potentialRoomPositions)
    {
        ...
        {
            var corridor = ThuatToanTaoMap.RandomWalkCorridor(currentPosition, corridorLength);
